                                ...
                                
                        {
                            this.state.treks.map(
                                ...
                                <div className="col-sm-4 text-center my-2" >
                                  <div className="card my-2 mx-2 shadow float-start animate__animated animate__backInUp" style={{borderRadius:"20px",width:"100%",height:"100%"}}>
                                    ...
                                    <img src={trek.imageId} className="card-img-top mx-2 my-2" style={{width:"400px"}}/>
                                      ...
                                      <a href="#" className="btn btn-danger shadow float-middle" style={{borderRadius:"12px"}}>Book now</a>
                                    </div>
                                  </div>
                                </div>
