    ...
    <div className="collapse navbar-collapse flex-row-reverse" id="navbarNav">
      <ul className="navbar-nav">
       <li className="nav-item">
          <a className="nav-a active" href="/travelAgentProfile"><button type="button" className="btn btn-outline-danger shadow mx-3"  style={{borderRadius:'12px'}} >Home</button></a>
        </li>
        <li className="nav-item">
